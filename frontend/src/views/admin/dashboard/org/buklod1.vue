...
<img src="../../../../assets/img/buklod.jpg" class="img-fluid" alt="" style="width: 100%; height: auto;">
</div>
</div>
</div>
      <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
        <h3>Buklod Christian Fellowship</h3>
        <p class="fst-italic">
            Buklod Christian Fellowship is a vibrant and inclusive religious community committed to fostering spiritual growth and Christian fellowship. Founded on the principles of love, unity, and faith, this fellowship seeks to create a supportive environment where individuals can deepen their relationship with God and build meaningful connections with fellow believers. With a focus on worship, discipleship, and community service, Buklod Christian Fellowship strives to empower its members to live out their faith in practical ways. The fellowship embraces diversity and encourages open dialogue,
             promoting a sense of belonging for everyone on their spiritual journey.
        </p>
        <ul>
          <li><i class="ri-check-double-line"></i> Emphasizes love, unity, and faith</li>
          <li><i class="ri-check-double-line"></i>Fosters spiritual growth and meaningful connections</li>
          <li><i class="ri-check-double-line"></i> Engages in worship, discipleship, and community service</li>
        </ul>
