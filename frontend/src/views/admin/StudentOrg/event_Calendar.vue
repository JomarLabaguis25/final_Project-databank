                ...
                <h1 class="m-0 text-primary" style="font-size: 1rem; font-weight: bold;">OSAS</h1>
                        ...
                        <div class="header__navbar">
                            <ul class="list-unstyled">
                                ...
                                <li>
                                    <a href="/insertEvent">
                                        <span class="bot-line"></span>Add Eventt</a>
                                </li>
                            </ul>
                        </div>
...
<div style="font-family: Arial, sans-serif; margin: 20px;">
    ...
    <thead>
        <tr style="background-color: #f2f2f2;">
            ...
            <th style="padding: 12px; text-align: center; border: 1px solid #ddd;">OrgName</th>
    ...
    <tbody v-for="info in info" :key="info.id">
        <tr>
            ...
            <td style="padding: 12px; border: 1px solid #ddd;">{{ info.OrgCategory}}</td>
