    ...
    <h1 class="m-0 text-primary" style="font-size: 1.5rem; font-weight: bold;">MinSU's Job Section</h1>
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">Electronics & Electrical Tech</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb text-uppercase">
                        <li class="breadcrumb-item"><a href="/">Home</a></li>
                        <li class="breadcrumb-item"><a href="category">Job Category</a></li>
                        <li class="breadcrumb-item text-white active" aria-current="page">Electronics & Electrical Tech</li>
                    </ol>
                </nav>
            </div>
        </div>
                            ...
                            <div class="job-item p-4 mb-4">
                                <div class="row g-4">
                                    <div class="col-sm-12 col-md-8 d-flex align-items-center">
                                        ...
                                        <div class="text-start ps-4"  v-for="job in inf" :key="job.id">
                                            
                                            <h5 class="mb-3">{{ job.jobName }}</h5>
                                            <span class="text-truncate me-3"><i class="fa fa-map-marker-alt text-primary me-2"></i>{{ job.jobLocation }}</span>
                                            <span class="text-truncate me-3"><i class="far fa-clock text-primary me-2"></i>{{ job.JobNature }}</span>
                                            <span class="text-truncate me-0"><i class="far fa-money-bill-alt text-primary me-2"></i>{{ job.jobSalary }}</span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12 col-md-4 d-flex flex-column align-items-start align-items-md-end justify-content-center">
                                        <div class="d-flex mb-3">
                                            <a class="btn btn-light btn-square me-3" href=""><i class="far fa-heart text-primary"></i></a>
                                            <a class="btn btn-primary" href="/jobDetails">Details</a>
                                        </div>
...
export default{
       ...
       mounted(){
           this.getWebInfo();
           const id = '1'; // Replace '1' with the actual ID you want to retrieve
    ...
    //    },
       methods:{
        async getinformation(id){
            try{
                const c = await axios.get('getinformation','$id');
                this.inf = c.data;
            }catch(error){
               console.log(error);
            }
