    ...
    <h1 class="m-0 text-primary" style="font-size: 1.5rem; font-weight: bold;">MinSU's Job Section</h1>
        ...
        <div class="container-xxl py-5 bg-dark page-header mb-5">
            <div class="container my-5 pt-5 pb-4">
                <h1 class="display-3 text-white mb-3 animated slideInDown">{{ categoryId }}</h1>
                    ...
                    <div class="tab-content">
                        <div id="tab-1" class="tab-pane fade show p-0 active">
                            <div class="job-item p-4 mb-4">
                                <div class="row g-4">
                                    <div v-for="job in infos" :key="job.id" class="col-sm-12 col-md-8 d-flex align-items-center">
...
export default{
    ...
    mounted(){
        this.categoryId = this.$route.params.jobCategory;
        this.getWebInfo();
        this.getData();
        // this.getjobs();
    ...
    methods:{
        ...
        async getData(){
            try{
                ...
                const a = await axios.get("getData");
                this.infos = a.data;
                // console.log(a);
            }catch(error){
            console.log(error);
