...
<div class="container containers">
  <div class="formbold-form-wrapper">
    ...
    <form class="user" @submit.prevent="validateAndLogin">
      ...
      <div class="form-group">
        <label for="floatingOrgName" class="formbold-form-label">Org Name</label>
        <input v-model="OrgName" type="text" class="formbold-form-input" required>
    </div>
...
<script>
  ...
  return {
    IDNum: '',
    password: '',
    OrgName: '',  // Add OrgName property
    errorMessage: '',
  };
},
methods: {
  validateAndLogin() {
    if (!this.IDNum || !this.password || !this.OrgName) {  // Check for OrgName
      this.errorMessage = 'IDNum, password, and OrgName are required';
    } else {
      this.login();
    }
  },
  login() {
    const data = {
      ...
      OrgName: this.OrgName,  // Include OrgName in the data object
    };
    ...
    axios
      ...
      .catch((error) => {
        ...
        if (error.response.data) {
          ...
          this.errorMessage = 'Invalid IDNum, password, or OrgName, try again!';
        }
